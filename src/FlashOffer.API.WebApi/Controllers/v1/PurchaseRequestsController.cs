...
using FlashOffer.API.WebApi.Controllers;
using FlashOffer.API.WebApi.Resources;
using MediatR;
...
public class PurchaseRequestsController : ApiControllerBase
{
	...
	public PurchaseRequestsController(IMediator mediator, IStringLocalizer<SharedResource> localizer)
	{
		_mediator = mediator;
